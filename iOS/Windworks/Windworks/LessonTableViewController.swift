...
class LessonTableViewController: UITableViewController {
    ...
    */
    ...
    private func loadSampleLessons() {
        ...
        guard let lesson1 = Lesson(name: "All", photo: photo_all) else {
            fatalError("Unable to instantiate lesson1")
        }

        guard let lesson2 = Lesson(name: "Basic Keelboat", photo: photo_bk) else {
            fatalError("Unable to instantiate lesson2")
        }

        guard let lesson3 = Lesson(name: "Basic Crusing", photo: photo_bc) else {
            fatalError("Unable to instantiate lesson3")
        }
        
        guard let lesson4 = Lesson(name: "Bareboat Cruising", photo: photo_bbc) else {
            fatalError("Unable to instantiate lesson4")
        }
        
        guard let lesson5 = Lesson(name: "Basic To Bareboat", photo: photo_btb) else {
